...
class UpdateGeneralsystem:
    ...
    def run_module(self, timestep, module_transfer, inputs):
        ...
        print('urban area grew.')
        module_transfer.lost_cropland += np.maximum(0, urb_growth)
        landuse, agri_areas = urban_growth(growth=urb_growth, LUmap=module_transfer.LandUse)
        ...
        self.create_output_dicts(landuse, expos, agri_areas, module_transfer)
    ...
    def create_output_dicts(self, landuse, expos, agri_areas, module_transfer):
